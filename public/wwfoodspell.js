...
const foodSpells = {
  "Nacho nuke": new Spell("Nacho nuke", getRandomInt(5, 8) * 2 * LOW, LOW, MANA_LOW, "attack"),
  "Sugarshock": new Spell("Sugarshock", getRandomInt(5, 8) * 2 * LOW, LOW, MANA_LOW, "attack"),
  "Spicebomb": new Spell("Spicebomb", getRandomInt(5, 8) * 2 * LOW, LOW, MANA_LOW, "attack"),
  "Frosting fix": new Spell("Frosting fix", getRandomInt(5, 8) * 2 * LOW, LOW, MANA_LOW, "heal"),
  "Gumdrop glow": new Spell("Gumdrop glow", getRandomInt(5, 8) * 2 * LOW, LOW, MANA_LOW, "heal"),
  "Wasabi whiplash": new Spell("Wasabi whiplash", getRandomInt(5, 8) * 2 * MEDIUM, MEDIUM, MANA_MEDIUM, "attack"),
  "Gravy grenade": new Spell("Gravy grenade", getRandomInt(5, 8) * 2 * MEDIUM, MEDIUM, MANA_MEDIUM, "attack"),
  "Fries of fury": new Spell("Fries of fury", getRandomInt(5, 8) * 2 * MEDIUM, MEDIUM, MANA_MEDIUM, "attack"),
  "Rhubarb remedy": new Spell("Rhubarb remedy", getRandomInt(5, 8) * 2 * MEDIUM, MEDIUM, MANA_MEDIUM, "heal"),
  "Casserole cure": new Spell("Casserole cure", getRandomInt(5, 8) * 2 * MEDIUM, MEDIUM, MANA_MEDIUM, "heal"),
